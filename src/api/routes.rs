...
/// The API endpoint for [`winvoice_schema::Login`]
pub const LOGIN: &str = "/login";

/// The API endpoint for [`winvoice_schema::Logout`]
pub const LOGOUT: &str = "/logout";

/// The API endpoint for [`winvoice_schema::Organization`]
pub const ORGANIZATION: &str = "/organization";

/// The API endpoint for [`winvoice_schema::Role`]
pub const ROLE: &str = "/role";

/// The API endpoint for [`winvoice_schema::Timesheet`]
pub const TIMESHEET: &str = "/timesheet";

/// The API endpoint for [`winvoice_schema::User`]
